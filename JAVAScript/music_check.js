...
function checkMusicFormular(){
    ...
    if (document.Formular.musicerscheinungsjahr.value == "") {
        ...
        document.Formular.musicerscheinungsjahr.style.border ="4px solid red";
        fehler = true;
    }else{
    ...
    if (document.Formular.songs.value == "") {
        ...
        document.Formular.songs.style.border ="4px solid red";
        fehler = true;
    }else{
    ...
    if (document.Formular.albumtitel.value == "") {
        ...
        document.Formular.albumtitel.style.border ="4px solid red";
        fehler = true;
    }else{
    ...
    if (document.Formular.interpreter.value == "") {
		...
		document.Formular.interpreter.style.border ="4px solid red";
        fehler = true;
    }else{
