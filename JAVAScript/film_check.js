...
function checkFilmFormular(){
    ...
    if (document.Formular.filmerscheinungsjahr.value == "") {
        ...
        document.Formular.filmerscheinungsjahr.style.border ="4px solid red";
        fehler = false;
    }else{
    ...
    if (document.Formular.schauspieler.value == "") {
        ...
        document.Formular.schauspieler.style.border ="4px solid red";
        fehler = false;
    }else{
    ...
    if (document.Formular.drehbuch.value == "") {
        ...
        document.Formular.drehbuch.style.border ="4px solid red";
        fehler = false;
    }else{
    ...
    if (document.Formular.regie.value == "") {
        ...
        document.Formular.regie.style.border ="4px solid red";
        fehler = false;
    }else{
    ...
    if (document.Formular.filmtitel.value == "") {
		...
		document.Formular.filmtitel.style.border ="4px solid red";
		fehler= false;
    }else{
